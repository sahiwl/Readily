    ...
    return (
        <div className='h-[calc(100vh-120px)] flex justify-center items-center bg-white'>
            <div className="w-full max-w-sm mx-auto bg-white brutal-border brutal-shadow px-8 pt-6 pb-8 mb-4">
                <h2 className='text-3xl font-black mb-6 uppercase tracking-tight' style={{ color: 'var(--color-secondary)' }}>Sign Up</h2>
                ...
                <p className='font-bold mt-6 text-sm'>Already have an account?
                    <Link to='/login' className='font-black underline' style={{ color: 'var(--color-accent)' }}> Login here</Link> </p>
